...
<body>
  ...
  {body}
  <footer>Generated by
    <a href="https://github.com/djouallah/duckrun/blob/main/integration_tests/multicatalog/demo_multicatalog.py">demo_multicatalog.py</a>
...
def main():
    if not (WAREHOUSE_PATH and WAREHOUSE_PATH.startswith("abfss://")
        ...
        print(
            ...
            "  WAREHOUSE_PATH=abfss://<ws>@onelake.dfs.fabric.microsoft.com/<lakehouse>/Tables   (writable lakehouse)\n"
            "  WAREHOUSE_RO_PATH=abfss://<ws>@onelake.dfs.fabric.microsoft.com/<warehouse>/Tables (read-only warehouse)\n"
            "then re-run:  python integration_tests/multicatalog/demo_multicatalog.py\n",
            flush=True,
        )
        return
