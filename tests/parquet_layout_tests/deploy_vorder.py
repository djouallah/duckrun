"""Deploy the benchmark semantic model(s) under tests/parquet_layout_tests/ (aemo_electricity_auto_sort
...
HERE = Path(__file__).resolve().parent            # this script lives in tests/parquet_layout_tests/
