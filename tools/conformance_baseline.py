...
HEADER = (
    ...
    "# A change fails if any id below is no longer passing (see tools/conformance_baseline.py).\n"
    "# To refresh: download the 'conformance-baseline' artifact from a green conformance run and\n"
    "# commit it over this file. Generated by tools/conformance_baseline.py — do not edit by hand.\n"
)
