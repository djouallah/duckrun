...
intended trade. Every table duckrun creates is stamped `delta.checkpointInterval = 10`,
so delta-rs checkpoints the log every 10 commits (no long JSON replay on open).
If a user asks "how do I schedule
