...
| Effective memory | 14950 MB (runner RAM, no artificial limit) |
| Merge spill cap | 8970 MB — delta_rs `max_spill_size` |
...
|---|---:|---:|---:|---:|---:|---:|:---:|:---:|---:|---:|
| Mixed upsert | 0.6M | 0.5M | 0.1M | 60.0M | 60.1M | 60.1M | ✅ | ✅ | 4,523 MB | 67.1s |
| Insert-only (future shipdate) | 3.0M | 0.0M | 3.0M | 60.1M | 63.1M | 63.1M | ✅ | ✅ | 2,572 MB | 15.8s |
| Update-only (100% match) | 3.2M | 3.2M | 0.0M | 63.1M | 63.1M | 63.1M | ✅ | ✅ | 4,297 MB | 72.4s |
| Idempotent re-merge | 0.0M | 0.0M | 0.0M | 63.1M | 63.1M | 63.1M | ✅ | ✅ | 5,038 MB | 79.0s |
| Append (no merge) | 3.2M | 0.0M | 3.2M | 63.1M | 66.3M | 66.3M | ✅ | ✅ | 1,126 MB | 14.9s |
| Safeappend (no merge) | 3.3M | 0.0M | 3.3M | 66.3M | 69.6M | 69.6M | ✅ | ✅ | 1,164 MB | 15.6s |
| Overwrite (no merge) | 3.5M | 0.0M | 3.5M | 69.6M | 3.5M | 3.5M | ✅ | ✅ | 1,146 MB | 16.0s |

**Result: ✅ all operations correct.** The chain tail reached **69,580,183 rows**, peak memory **5,038 MB** — duckrun stayed within the runner's RAM and every update/insert landed through the dbt path.
