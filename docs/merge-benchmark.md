...
| Expression update (set expressions + CASE) | 1.5M | 1.5M | 0.0M | 30.0M | 30.0M | 30.0M | ✅ | ✅ | 4,632 MB | 36.1s |
...
**Result: ✅ all operations correct.** The chain tail reached **69,582,509 rows**, peak memory **6,027 MB** — duckrun stayed within the runner's RAM and every update/insert landed through the connection API.
