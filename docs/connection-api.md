...
| `DataFrameWriter` | `saveAsTable`, `mode`, `option`, `partitionBy`, `sort`, `orderBy_alias_and_desc`, `sort_no_args_auto_key`, `sort_then_partition_write`, `format`, `save_by_path`, `save_modes`, `save_mode_error_when_exists` | 12/12 ✅ |
