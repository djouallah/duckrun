...
| `DeltaTable` | `forName`, `forPath`, `convertToDelta`, `merge`, `version`, `history`, `delete`, `update`, `optimize`, `optimize_experimental_sort`, `optimize_sort_bad_value`, `vacuum`, `restoreToVersion` | 13/13 ✅ |
